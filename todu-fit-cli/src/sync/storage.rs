...
//!
//! Documents are stored in the platform-specific data directory:
...
///
/// // Load it back
/// let loaded = storage.load(DocType::Dishes).unwrap();
...
impl DocumentStorage {
    /// Creates a new storage instance using the default data directory.
    pub fn new() -> Self {
        Self {
